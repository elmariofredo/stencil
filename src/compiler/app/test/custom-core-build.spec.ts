...
describe('setComponentCoreBuild', () => {
  ...
  describe('styles', () => {
    ...
    it('set scoped', () => {
      ...
      expect(coreIncludeSections.$build_scoped_css).toBeTruthy();
    });

    it('set shadow', () => {
      cmpMeta.encapsulation = ENCAPSULATION.ShadowDom;
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_shadow_dom).toBeTruthy();
    });

    it('set styles', () => {
      cmpMeta.stylesMeta = {};
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_styles).toBeTruthy();
    });
  ...
  describe('decorators', () => {
    ...
    it('set listener', () => {
      ...
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_listener).toBeTruthy();
    });

    it('set state', () => {
      cmpMeta.membersMeta.member = { memberType: MEMBER_TYPE.State };
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_state).toBeTruthy();
    });

    it('set prop mutable', () => {
      cmpMeta.membersMeta.member = { memberType: MEMBER_TYPE.PropMutable };
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_prop).toBeTruthy();
    });
    ...
    it('set prop context', () => {
      ...
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_prop).toBeTruthy();
      expect(coreIncludeSections.$build_prop_context).toBeTruthy();
    });
    ...
    it('set prop connect', () => {
      ...
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_prop).toBeTruthy();
      expect(coreIncludeSections.$build_prop_connect).toBeTruthy();
    });
    ...
    it('set method', () => {
      ...
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_method).toBeTruthy();
    });

    it('set events', () => {
      cmpMeta.eventsMeta = [{}];
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_event).toBeTruthy();
    });

    it('set element', () => {
      cmpMeta.membersMeta.member = { memberType: MEMBER_TYPE.Element };
      setComponentCoreBuild(coreIncludeSections, cmpMeta);
      expect(coreIncludeSections.$build_element).toBeTruthy();
    });
